...
def write_to_sheet(idempotency_key: str, source: str, result: ZPulseResult) -> bool:
    try:
        # Optimization: Removed unused data formatting (e.g., json.dumps) and row construction
        # since sheet.append_row is commented out. This avoids unnecessary CPU overhead.
