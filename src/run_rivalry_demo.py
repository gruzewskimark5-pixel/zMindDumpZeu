...
def run_rivalry_demo():
    ...
    shared_holes = [
        {"hole_id": 16, "DI": 0.68, "score_a": 4, "score_b": 6},
        {"hole_id": 17, "DI": 0.59, "score_a": 3, "score_b": 3},
        {"hole_id": 18, "DI": 0.62, "score_a": 4, "score_b": 5}
    ]
    ...
    # Update RHI
    new_rhi, momentum, delta = update_rhi(initial_rhi, d_ab, di_ab, id_ab, e_ab, decay_ab, initial_momentum)
